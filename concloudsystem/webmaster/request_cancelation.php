            ...
            <div class="page_top_wrap_left">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Request For Cancelation</li>
                    </ol>
                </nav>
                <h2>Request For Cancelation</h2>
            ...
            <div class="spot_box">
                ...
                <div class="spot_box_bottom">
                    <div class="spot_box_bottom_left">
                        ...
                        <h6 class="badge_success">Refund Amount: <n><?php rupee() ?> 5000</n>
                        </h6>
                    </div>
